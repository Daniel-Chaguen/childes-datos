...
**Script:** `scripts/split_binary.py`  
...
# Stage 3 — Binary split
python3 ../scripts/split_binary.py
...
> **Note:** Each run of `split_binary.py` wipes and rebuilds `categorized_bi/` from scratch.  
> Each run of `run_prepare_childes.py` wipes and rebuilds `prepared_bi/` from scratch.
